...
@Entity
@Table(name="majournee")
@EntityListeners(AuditingEntityListener.class)
public class Majournee implements Serializable{
	...
	private int idSoldeDebuterJournee;
	private int idU;
	@Id
	...
	public Majournee(double caisse, double orange, double expresso, double freeMoney, double wari, double wizall,
			...
			int idSoldeDebuterJournee,int idU) {
		super();
		this.caisse = caisse;
		this.orange = orange;
		...
		this.date=date;
		this.status=status;
		this.idSoldeDebuterJournee = idSoldeDebuterJournee;
		this.idU = idU;
	}

	public Majournee(double caisse, double orange, double expresso, double freeMoney, double wari, double wizall,
			double proximo, double xpress, double yup, double wave, double banque,double cloturer, double sommeInitiale,String date,int status,
			int idSoldeDebuterJournee,int idU, int id) {
		super();
		this.caisse = caisse;
		this.orange = orange;
		this.expresso = expresso;
	...
	public int getIdSoldeDebuterJournee() {
		return idSoldeDebuterJournee;
	}

	public void setIdSoldeDebuterJournee(int idSoldeDebuterJournee) {
		this.idSoldeDebuterJournee = idSoldeDebuterJournee;
	}
