...
public class SoldeDebuterAnnee implements Serializable{
	...
	private int id;
	public SoldeDebuterAnnee() {
		super();
	}
	public SoldeDebuterAnnee(double caisse, double orange, double expresso, double freemoney, double wari, double wizall,
